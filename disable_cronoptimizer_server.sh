...
_note "Running Cron Optimizer disable operation for Server ID $server"

while read app; do
    _note "Disabling Cron Optimizer for App ID: $app on Server: $server"
    echo ""
...
_success "Cron Optimizer disabled successfully on all WordPress apps for Server ID $server."